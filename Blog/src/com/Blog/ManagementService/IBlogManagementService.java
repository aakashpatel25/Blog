...
public interface IBlogManagementService {
	 ...
	 * @return boolean If the comment was deleted.
	 */
	public boolean deleteComment(String author, String title, String username);

	/**
	 * To delete all comments on the blog.
	 * 
	 * @param author
	 *            Author of the blog.
	 * @param title
	 *            Title of the post.
	 * @return boolean If all the comments were deleted on that post.
	 */
	public boolean deleteBlogComments(String author, String title);
}
